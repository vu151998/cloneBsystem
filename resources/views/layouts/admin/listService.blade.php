...
<body style="background-color: white;">
  ...
  <div class="row" id="body-row">
    ...
    <div class="col p-4">
      ...
      <!--<div class="card">-->
      <h5 class="card-header font-weight-light" style="text-align: center;">QUẢN LÝ DỊCH VỤ</h5>
      <!-- list -->
      <!--<div id="test">-->
      <div class="card-body">
        <div class="container">
          ...
               <div class="row">
                  <div class="col col-xs-6">
                 <form class="d-flex">
                ...
                <div style="float: left;">
                  <input class="form-control me-2" type="search" placeholder="Tìm kiếm dịch vụ" aria-label="Search"
            ...
                  <div class="col col-xs-6 text-right">
                     <button type="button" class="btn btn-outline-success" style="margin-top: 23px;margin-left: 250px;"
    ...
    <form class="modal-content animate" action="/action_page.php" method="post">
      ...
      <div class="container">
        ...
        <div>
          ...
          <div style="float: left;margin-left: 110px;width: 44%;">
            <label for="uname"><b>Hình ảnh</b></label>
            <input type="text" placeholder="" name="uname" required>
          </div>
        </div>
  ...
  <div id="id01" class="modal">
    ...
    <form class="modal-content animate" action="/action_page.php" method="post">
      ...
      <div class="container">
        ...
        <button onclick="document.getElementById('id04').style.display='block'" style=" background-color: #04AA6D;
                                     color: white;
                                     padding: 14px 20px;
                                      margin: 8px 0;
                                      border: none;
                                    cursor: pointer;
                                    width: 45%;">Edit Sản phẩm </button>
