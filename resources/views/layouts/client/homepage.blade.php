...
<html>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                {{-- <a class="navbar-brand" href="#page-top"><img src="" alt="BigGara" /></a> --}}
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto py-4 py-lg-0 ">
                        <li class=' nav-item droppable'><a class="nav-link" href="#services">Dịch vụ</a>
                            <div class='mega-menu'>
                        ...
                        <li class="nav-item"><a class="nav-link" href="#portfolio">Gian Hàng</a></li>
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-heading text">Chào mừng đến với BigGara</div>
                <div class="masthead-subheading">Đam mê của bạn là sự hài lòng của  chúng tôi</div>
        ...
        <section class="page-section" >
            <div class="container">
                <div class="text-center">
                    ...
                    {{-- <h3 class="section-subheading text-muted">Chúng tôi là số 2, không ai là số 1</h3> --}}
                </div>
                <div class="row text-center">
                    <div class="col-md-3">
                        <span class="fa-stack fa-4x">
                            <img  src="assets/img/chinhhang.png" alt="..." />
                            {{-- <i class="fas fa-circle fa-stack-2x text-primary"></i>
                            <i class="fas fa-shopping-cart fa-stack-1x fa-inverse"></i> --}}
                        </span>
                        
                        <p class="text-muted">Lmaxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
                    </div>
                    <div class="col-md-3">
                        <span class="fa-stack fa-4x">
                            <img class="img-fluid" src="assets/img/vanchuyen.jpg" alt="..." />
                        </span>
                    ...
                    <div class="col-md-3">
                        <span class="fa-stack fa-4x">
                            <img class="img-fluid" src="assets/img/thanhtoan.png" alt="..." />
                        </span>
                    ...
                    <div class="col-md-3">
                        <span class="fa-stack fa-4x">
                            <img class="img-fluid" src="assets/img/suachuatainha.jpg" alt="..." />
     ...
     <section class="page-section bg-light" id="services">
        ...
        <section class="page-section" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Sản phẩm được quan tâm</h2>
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6 mb-4">
                        ...
                        <div class="portfolio-item">
                            ...
                            <div class="portfolio-caption">
                                <div class="portfolio-caption-heading">Màn hình xe</div>
                    ...
                    <div class="col text-center">
                        <p><a class="btn btn-secondary"  href="{{ route('shophome.index') }}">Đi tới gian hàng »</a></p>
